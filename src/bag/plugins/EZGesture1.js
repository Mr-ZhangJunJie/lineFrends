...
(function(){
    ...
    var EZGestureClass = function(containerDom, targetDom, opt){
        ...
        // console.log(this.targetDom.offsetWidth, '>>>', this.targetDom.offsetHeight)
        // console.log(this.targetMinWidth, '>>>', this.targetMinHeight)

        setTimeout(() => {
            if (this.targetDom.offsetWidth <= this.targetDom.offsetHeight) {
                ...
                // console.log(this.targetDom.offsetWidth*this.targetMinHeight / this.targetMinWidth)
                // console.log(this.targetDom.offsetHeight - 2)

                if ((this.targetDom.offsetWidth*this.targetMinHeight / this.targetMinWidth) < (this.targetDom.offsetHeight - 2)) {
                    this.targetDom.style.height = 'auto';
                    this.targetMinWidth = this.targetDom.offsetWidth
                    this.targetMinHeight = 0
                    this.targetDom.style.width = '100%'
